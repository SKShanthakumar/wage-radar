...
function submitForm(e) {
  ...
  saveMessages(name,age,pincode,gender,dob,phnum,altphnum,email,password,resAdd,profession);

  document.getElementById("WgRdrEmployerReg").reset();
}

const saveMessages = (name,age,pincode,gender,dob,phnum,altphnum,email,password,resAdd,profession) => {
