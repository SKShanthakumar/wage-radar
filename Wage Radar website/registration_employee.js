...
function submitForm(e) {
  ...
  saveMessages(name,age,pincode,gender,dob,phno,altphno,mobiletype,language,email,password,aadhar,resadd,skill1,skill2,skill3,wage1,wage2,wage3);

  document.getElementById("WgRdrEmployeeReg").reset();
}

const saveMessages = (name,age,pincode,gender,dob,phno,altphno,mobiletype,language,email,password,aadhar,resadd,skill1,skill2,skill3,wage1,wage2,wage3) => {
